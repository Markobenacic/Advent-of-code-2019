...
public class Amplifier2 {
	...
	public Amplifier2(ArrayList<Long> array, long phaseSetting) {
	...
	public long run(long inputX) {
		...
		while(arr.get((int)(long)pointer) != 99) {
			...
			if(opcode == 1) {
				...
				modes[0] = 0;
				long address = arr.get((int)(long)pointer + 1);
				System.out.println("amp number: " + this.phaseSetting + " output: " + arr.get((int)address));
